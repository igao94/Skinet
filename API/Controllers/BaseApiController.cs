...
{
    protected async Task<ActionResult> CreatePagedResultAsync<T>(IGenericRepository<T> repo,
    ...
    protected async Task<ActionResult> CreatePagedResultAsync<T, TDto>(IGenericRepository<T> repo,
        ISpecification<T> spec, 
        int pageIndex, 
        int pageSize,
